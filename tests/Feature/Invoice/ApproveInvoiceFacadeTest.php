 ...
 * @group Invoice
 * @group Facade
 * @group ApproveInvoiceFacadeTest
 */
class ApproveInvoiceFacadeTest extends TestCase
{
    ...
    public function testApproveInvoiceWithStatusDraftReturnsSuccess(): void
    {
        // Arrange
        ...
        // Act
        $invoiceStatusChangeResponseDto = $invoiceFacade->approveInvoice($invoiceStatusChangeRequestDto);
    ...
    public function testApproveInvoiceWithStatusRejectedReturnsError(): void
    {
        // Arrange
        $invoiceFacade = $this->getFacade();
        $company = $this->companyHelper->createCompany([]);
    ...
    public function testApproveInvoiceWithInvalidIdReturnsError(): void
    {
        // Arrange
        $invoiceFacade = $this->getFacade();
